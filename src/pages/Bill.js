  ...
  return (
    <div className="mt-[160px] lg:px-10">
      <div className=" w-[100%] items-center  ">
        <div>
          <h1 className="ml-5 p-4 font-bold text-4xl ">Checkout</h1>
        ...
        <div className="lg:flex gap-4 col w-[100%] ">
          <div>
            ...
            <hr className="border border-orange-400 border-b-2 m-2 w-auto" />
            <form className="col">
              <div className=" m-6">
                <div className="text-xl col sm:flex gap-5 ">
                  <div>
                    ...
                    <input
                      ...
                      name="First Name"
                      id="fname"
                      className="p-1 w-full border-slate-900 border border-dotted"
                 />
                    <br />
                  </div>
                ...
                <div className="text-xl mt-5 ">
                  ...
                  <div>
                    <input
                      ...
                      name="Country / Region "
                      value="India"
                      className="p-1 border-slate-900 border border-dotted w-full"
                     />
                  </div>
                </div>
                <div className="text-xl mt-5 ">
          ...
          <div className="border border-black lg:w-[50%] w-auto mb-3 mx-2">
            <div>
              <h1 className="mx-auto p-3 text-2xl text-slate-800 font-bold ">Your order</h1>
            ...
            <div className="p-5 m-4 text-2xl">
              ...
              <div className="py-7 flex gap-3">
                ...
                <img
                  ...
                  alt="image"
                  className="w-[20%] h-[40px] shadow-xl border border-slate-400"
                />
              </div>
              <div className="py-7 px-3 text-center">
                <button onClick={handleClick} className="text-white p-2 w-full bg-orange-400 hover:bg-blue-500 ">PLACE ORDER</button>
              </div>
            </div>
          </div>
        </div>
