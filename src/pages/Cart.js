      ...
      <div className="flex ">
        <div className=" w-full md:w-10/12 lg:w-10/12 lg:mx-20 lg:my-10 md:mx-20 md:my-10  ">
          <div className="text-center">
            <h2 className=" py-7 text-3xl font-semibold  ">Shoppig Cart</h2>
          </div>
          <div className="bg-black h-px my-3 block sm:hidden"></div>
          <div className=" bg-orange-400 hidden sm:block ">
            <div className=" font-semibold  py-2 grid grid-cols-5  mx-12   md:mx-10 justify-between text-black">
              <h4>Image</h4>
              <h4>Name</h4>
              <h4>Quantity</h4>
              <h4>Price</h4>
          ...
          {cart.map((item) => (
            <div key={item.id} >
              <div className="grid grid-cols-1 sm:grid-cols-5 mx-28 lg:mx-10 md:mx-8 items-center text-black  ">
                <div>
                  <img
                    src={item.img}
                    alt={item.id}
          ...
          <div className="  px-10 lg:px-0 md:px-0 flex flex-col md:flex-row lg:flex-row">
            <span className="">Total Price of Your Cart</span>
            <span className="md:mx-[30%] lg:mx-[34%] xl:mx-[40%] ">Rs-{price}</span>
          </div>
          <div>
            <Link to="/Bill">
          <button className=" ml-24 my-5  md:ml-60 md:my-10 lg:ml-[50%] lg:my-10 bg-orange-400 p-2  text-black rounded-sm px-5 py-2 ">
